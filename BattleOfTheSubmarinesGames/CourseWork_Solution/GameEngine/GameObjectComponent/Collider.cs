...
namespace GameEngine
{
    public abstract class Collider : GameComponents
    {
        ...
        /// <summary>
        /// Проверка на столкновение игровых объектов.
        /// </summary>
        /// <param name="gameObject_1"> Первый объект. </param>
        /// <param name="gameObject_2"> Второй объект. </param>
        /// <returns> Логическо значение, обозначающее произошло ли столкновение. </returns>
        ...
        /// <summary>
        /// Проверка нахождения игрового объекта на определённой позиции.
        /// </summary>
        /// <param name="gameObject"> Игровой объект. </param>
        /// <param name="point"> Конкретная точка. </param>
        /// <returns></returns>
