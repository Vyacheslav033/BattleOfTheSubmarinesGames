...
namespace Submarine_Library.OpenTK_Graphics
{
    ...
    //        var rocket = new FieryTorpedo(direction);
    ...
    //                            if (go is Torpedo && gameObject is Submarine)
    //                            {
    ...
    //            if (gameObjects[i] is Torpedo)
    //            {
    //                var rocket = (Torpedo)gameObjects[i];
    //                rocket.Move(Direction.Right, e.Time * rocket.Speed);
    //            }
    //        }
    //    }
